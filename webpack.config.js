    ...
    module: {
        rules: [
            ...
            // Transpile our source files and selected node_modules (including .js, .mjs, and .cjs files)
            {
                ...
                //     @solana/codecs-numbers, @solana/spl-token-group, **@solana/codecs-strings,** and **@solana/codecs-core.**
                // It also whitelists @noble/curves, superstruct, and rpc-websockets.
                test: /\.(mjs|cjs|js)$/,
                exclude: /node_modules\/(?!(@solana\/(web3\.js|codecs|codecs-data-structures|spl-token|spl-token-metadata|errors|options|codecs-numbers|spl-token-group|codecs-strings|codecs-core)|@noble\/curves|superstruct|rpc-websockets)\/)/,
                loader: 'babel-loader',
                options: {
                    presets: [
                        ['@babel/preset-env']
